...
const context={document:{readyState:'complete',getElementById:()=>null,body:{}},MutationObserver:class{observe(){}},indexedDB:{},alert(){},confirm(){return false},console,URL,Blob,setTimeout,clearTimeout};
vm.runInNewContext(source,context);
const api=context.__mlBackupV230;
const legacy={app:'Minha Lista de Supermercado',version:'2.2',schemaVersion:3,exportedAt:'2026-01-01T00:00:00.000Z',catalogs:[{id:'cat-001',name:'Arroz'}],lists:[{id:'list-001',name:'Compras',date:'2026-01-01',items:[{id:'item-001',mainItemId:'cat-001',done:false,quantity:2,value:10,date:'2026-01-01'}]}],history:[{id:'hist-001',mainItemId:'cat-001',itemName:'Arroz',value:10,date:'2026-01-01',createdAt:'2026-01-01T00:00:00.000Z'}]};
