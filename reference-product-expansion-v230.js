(() => {
  ...
  const groups = [
    [
      ...
      ['Camil', 'Tio João', 'Urbano', 'Yoki', 'Kicaldo', 'Qualitá', 'Renata', 'Dona Benta'],
    ...
    [
      ...
      ['Bauducco', 'Piraquê', 'Marilan', 'Vitarella', 'Nestlé', 'Mãe Terra', 'Yoki', 'Qualitá'],
      ['80 g', '100 g', '150 g', '200 g', '300 g', '400 g', '500 g'],
    ],
    [
      'Bebidas',
      [
      ...
      ['Del Valle', 'Aurora', 'Kapo', 'Leão', 'Matte Leão', 'Minalba', 'Indaiá', 'Ades'],
    ...
    [
      ...
      ['Nestlé', 'Vigor', 'Itambé', 'Piracanjuba', 'Ninho', 'Batavo', 'Elegê', 'Catupiry'],
      ['90 g', '120 g', '170 g', '200 g', '300 g', '400 g', '500 g', '1 kg'],
    ],
    [
      'Carnes',
      [
      ...
      ['Sadia', 'Seara', 'Friboi', 'Swift', 'Perdigão', 'Aurora', 'Minerva', 'Qualitá'],
      ['300 g', '500 g', '700 g', '1 kg', '1,5 kg', '2 kg'],
    ],
    [
      'Hortifruti',
      [
      ...
      ['Hortifruti', 'Qualitá', 'Carrefour', 'Oba', 'Sítio Verde', 'Feira', 'Da Horta', 'Genérico'],
      ['500 g', '1 kg', '2 kg', '1 un', '2 un'],
    ],
    [
      'Congelados',
      [
      ...
      ['Sadia', 'Seara', 'Perdigão', 'Forno de Minas', 'Frooty', 'Kibon', 'Qualitá', 'Swift'],
    ...
    [
      ...
      ['200 g', '300 g', '400 g', '500 g', '600 g', '1 kg'],
    ],
    [
      'Limpeza',
      [
      ...
      ['Veja', 'Ypê', 'Limpol', 'Omo', 'Vanish', 'Bombril', 'Comfort', 'Qboa'],
      ['250 ml', '500 ml', '750 ml', '1 L', '1,5 L', '2 L'],
    ],
    [
      'Higiene',
      [
      ...
      ['Dove', 'Nivea', 'Pantene', 'Seda', 'Colgate', 'Sorriso', 'Oral-B', 'Johnson’s'],
      ['50 g', '90 g', '100 ml', '150 ml', '200 ml', '250 ml', '350 ml', '500 ml'],
    ],
    [
      'Pet',
      [
      ...
      ['100 g', '300 g', '500 g', '1 kg', '2 kg', '5 kg', '10 kg', '15 kg'],
    ],
  ];
    ...
    openDB()
      .then(async (db) => {
        ...
        await new Promise((resolve, reject) => {
          ...
          transaction.onerror = () =>
            reject(transaction.error || Error('Falha ao expandir banco de referência'));
