(() => {
  ...
  const STYLE = `
    ...
    body.v3-ui { --primary:var(--v3-accent); --primary2:var(--v3-accent-strong); --soft:var(--v3-accent-soft); --danger:var(--v3-accent); --dangerSoft:var(--v3-accent-soft); background:var(--bg); }
    body.v3-ui .badge, body.v3-ui .pill, body.v3-ui .notice, body.v3-ui .warning, body.v3-ui .danger-zone { color:var(--v3-accent); background:var(--v3-accent-soft); border-color:var(--v3-accent-border); }
    body.v3-ui .notice strong, body.v3-ui .warning strong { color:var(--v3-accent); }
    body.v3-ui .btn.danger { background:var(--v3-accent-soft); color:var(--v3-accent); }
    body.v3-ui .check:checked, body.v3-ui .btn.primary { background:var(--v3-accent); border-color:var(--v3-accent); }
    body.v3-ui .btn.primary:active { background:var(--v3-accent-strong); }
    body.v3-ui .input:focus, body.v3-ui .select:focus, body.v3-ui .textarea:focus { border-color:var(--v3-accent); box-shadow:var(--v3-focus); }
    body.v3-ui .iconbtn, body.v3-ui .close, body.v3-ui .v3-menu-toggle, body.v3-ui .v3-drawer-close { color:var(--v3-accent); }
    body.v3-ui .iconbtn:hover, body.v3-ui .close:hover { background:var(--v3-accent-soft); }
    body.v3-ui .empty .emoji { font-size:0; }
    body.v3-ui .ml-v3-icon { width:1.15em; height:1.15em; display:inline-block; vertical-align:-0.18em; flex:0 0 auto; color:var(--v3-accent); }
    body.v3-ui .ml-v3-icon svg { width:100%; height:100%; display:block; fill:none; stroke:currentColor; stroke-width:1.8; stroke-linecap:round; stroke-linejoin:round; }
    body.v3-ui .nav-icon .ml-v3-icon { width:21px; height:21px; }
    body.v3-ui .iconbtn .ml-v3-icon, body.v3-ui .close .ml-v3-icon { width:19px; height:19px; }
