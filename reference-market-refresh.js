(() => {
  ...
  function bindManualButton() {
    const host = document.querySelector('#settingsView .panel:nth-of-type(2) .row');
    if (!host || document.getElementById('offlineDbRefreshBtn')) return;
    const button = document.createElement('button');
    button.id = 'offlineDbRefreshBtn';
    button.className = 'btn ghost';
    button.type = 'button';
    button.textContent = '🔄 Atualizar banco de dados offline';
