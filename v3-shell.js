(() => {
  ...
  const STYLE = `
    ...
    body.v3-ui {
      background:
        radial-gradient(circle at 50% -10%, rgba(22,163,74,.10), transparent 38%),
        var(--bg);
      letter-spacing: -.01em;
    }
    body.v3-ui .app {
    ...
    body.v3-ui .badge {
      ...
      box-shadow: 0 5px 18px rgba(22,163,74,.08);
    }
    body.v3-ui .panel,
    body.v3-ui .card {
      border-radius: 20px;
      box-shadow: 0 10px 30px rgba(20,40,28,.045);
    }
    body.v3-ui .panel {
      padding: 18px;
      margin-bottom: 14px;
    ...
    body.v3-ui .card:hover {
      transform: translateY(-1px);
      box-shadow: 0 13px 34px rgba(20,40,28,.07);
    }
    body.v3-ui .section-title {
      font-size: 18px;
    ...
    body.v3-ui .btn.primary {
      box-shadow: 0 5px 14px rgba(22,163,74,.15);
    }
    body.v3-ui .btn.ghost,
    body.v3-ui .iconbtn,
    body.v3-ui .close {
    ...
    body.v3-ui .stat {
      ...
      background: color-mix(in srgb, var(--card) 72%, var(--soft));
      border-radius: 15px;
      padding: 12px 9px;
    }
    body.v3-ui .subcard {
    ...
    body.v3-ui .nav button.active .nav-icon {
    ...
    body.v3-ui .v3-menu-toggle::before,
    body.v3-ui .v3-menu-toggle::after,
    body.v3-ui .v3-menu-toggle {
      /* O desenho é CSS para manter o botão nítido sem emoji dependente da fonte. */
    }
    body.v3-ui .v3-menu-toggle::before {
      content: '☰';
      font-size: 21px;
    ...
    body.v3-ui .iconbtn,
    body.v3-ui .close,
    body.v3-ui .v3-menu-toggle { transition: transform .12s ease, box-shadow .12s ease; }
    ...
    @media (min-width: 821px) {
      body.v3-ui .app { padding-top: 24px; }
    }
    @media (max-width: 620px) {
      body.v3-ui .app { width: 100%; padding: 10px 12px 102px; }
      body.v3-ui .top { padding-bottom: 13px; }
      body.v3-ui .top h1 { font-size: 22px; }
      body.v3-ui .top .sub { font-size: 12px; }
      body.v3-ui .panel { padding: 15px; border-radius: 18px; }
      body.v3-ui .card { border-radius: 17px; }
      body.v3-ui .nav { width: min(88vw, 330px); }
    }
    @media (prefers-reduced-motion: reduce) {
      body.v3-ui .nav,
      body.v3-ui .v3-menu-overlay,
      body.v3-ui .card { transition: none; }
    }
  `;
